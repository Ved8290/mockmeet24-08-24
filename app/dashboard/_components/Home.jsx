...
function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <header className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-10 relative">
        ...
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-5xl font-extrabold mb-6">Master Your Interviews with MockMeet</h1>

          <p className="mt-4 text-xl"> The Perfect Blend of AI and Expert Insights for Your Interview Success! </p>
          <p className="mt-4 text-xl">AI-driven mock interviews tailored to your dream job.</p>
          <div className="mt-8">
            <a href="/dashboard" className="px-8 py-4 bg-white text-indigo-600 rounded-lg font-bold text-lg shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105 duration-300">
              Get Started
            </a>
          </div>
        </div>
      ...
      <section className="container mx-auto my-16 p-8">
        ...
        <div className="grid md:grid-cols-3 gap-12 text-center">
          <div className="group">
            <img src="https://images.unsplash.com/photo-1653669487058-1adbacc40e00?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Choose a Job Position" className="mx-auto mb-4 rounded-lg transform group-hover:scale-105 transition duration-300 shadow-lg" />
...
<section className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-20">
  <div className="container mx-auto text-center">
    <h2 className="text-5xl font-extrabold mb-6">Dare to Crush Your Next Interview?</h2>
    <p className="text-xl mb-8">Start Your Free Trial Today & Get the Confidence You Deserve!</p>
    <a href="/dashboard" className="inline-block px-10 py-5 bg-white text-indigo-600 rounded-full font-bold text-lg shadow-lg hover:bg-gray-100 transition-transform transform hover:scale-105 duration-300">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="p-6 group">
              <img src="https://img.freepik.com/free-vector/job-interview-conversation_74855-7566.jpg" alt="Realistic Interviews" className="mx-auto mb-4 rounded-lg shadow-lg transform group-hover:scale-105 transition duration-300" />
            ...
            <div className="p-6 group">
              <img src="https://myvistage.com/hub/wp-content/uploads/sites/4/2023/12/23_222_0099-AI-future-business-featured-image-1024x686-1.jpg" alt="AI-Powered Feedback" className="mx-auto mb-4 rounded-lg shadow-lg transform group-hover:scale-105 transition duration-300" />
            ...
            <div className="p-6 group">
              <img src="https://img.freepik.com/free-vector/flat-web-development-concept-cms_23-2148806100.jpg" alt="Customizable Scenarios" className="mx-auto mb-4 rounded-lg shadow-lg transform group-hover:scale-105 transition duration-300" />
            ...
            <div className="p-6 group">
              <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97" alt="Track Your Progress" className="mx-auto mb-4 rounded-lg shadow-lg transform group-hover:scale-105 transition duration-300" />
      ...
      <section className="flex items-center justify-center min-h-screen bg-gradient-to-r from-purple-600 via-blue-500 to-indigo-700 text-white">
        <div className="max-w-3xl p-10 bg-opacity-80 bg-gray-800 rounded-3xl shadow-2xl">
          <h2 className="text-5xl font-extrabold mb-8 text-center animate-fade-in">
            What We Do
          </h2>
